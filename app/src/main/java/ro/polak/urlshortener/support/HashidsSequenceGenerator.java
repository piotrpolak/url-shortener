 ...
 * scalable) with the text-ids that are hard to reverse engineer (and predict the next value).
 *
 * <p>The generator allows to avoid integer/long ids in your database schema at all.
 */
public class HashidsSequenceGenerator extends SequenceStyleGenerator {
  ...
  public void configure(Type type, Properties params, ServiceRegistry serviceRegistry)
    ...
    String salt = ConfigurationHelper.getString(SALT_PROPERTY_NAME, params, DEFAULT_SALT);
